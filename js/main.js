...
function loaded() {
    ...
    myScroll = new IScroll('#wrapper', {
        probeType: 2  //probeType属性，表明此插件，可以监听scroll事件,如果没有probeType属性，就不能监听scroll事件
    ...
    myScroll.on('scroll', function () {
        ...
        if (this.y > 5 && !pullDownEl.className.match('flip')) { //只有当下拉超过5px，并且没有flip才添加，否则下拉只要超过5px,会一直添加flip,造成重复操作
